...
myPowerSaveLight.setPowerSave(True) #Turn on the power to the temp sensor
...
IR=100
UV=100
print ("ReadSunlightSensor=" + str(ReadLightSensor))
if (ReadLightSensor == True):
	...
	UV = sensor.readUV()
	uvIndex = UV / 100.0
	print('Initial SunLight Sensor read at time: %s' % datetime.datetime.now())
	print('		Vis:             ' + str(vis))
	print ('		IR:              ' + str(IR))
	...
	body = [
	    	{
	       	 ...
	       	 "fields": {
       		     ...
       		     "TotalRain": totalRain,
	       	     "OutdoorTemp": temperature*9/5+32,
