...
#Need to reset the sensor occasionally if it fails on a read
GPIO_Pin_PowerSave = 12
...
try:
	...
	print ("Temp sensor failure -  continuing")	
	print 'Temp sensor reset'
	myPowerSave.setPowerSave(False) #Power off the outdoor temp sensor
	time.sleep(10)
	myPowerSave.setPowerSave(True) #Power on the outdoor temp sensor
	#Try reading again
	device_folder = glob.glob(base_dir + '28*')[0]
	device_file = device_folder + '/w1_slave'
...
sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Pi_SSD1306')
sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Pi_INA3221')
sys.path.append('/home/pi/weather-station/WeatherBoard/RTC_SDL_DS3231')
sys.path.append('/home/pi/weather-station/WeatherBoard/Adafruit_Python_BMP')
sys.path.append('/home/pi/weather-station/WeatherBoard/Adafruit_Python_GPIO')
sys.path.append('/home/pi/weather-station/WeatherBoard/Adafruit_Python_SSD1306')
sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Pi_WeatherRack')
sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Pi_FRAM')
sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Pi_TCA9545')
sys.path.append('/home/pi/weather-station/WeatherBoard/RaspberryPi-AS3935/RPi_AS3935')
sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Adafruit_ADS1x15')

sys.path.append('/home/pi/weather-station/WeatherBoard/SDL_Pi_SI1145'); # Sun sensor
...
crc_check=0 #Obsolete field needed to fill the record
#Write the log file
